...
#service
print(restaurant_objects[service_sort[0]].service[0])
print(restaurant_objects[service_sort[0]].name)

print(restaurant_objects[service_sort[1]].service[0])
print(restaurant_objects[service_sort[1]].name)

print(restaurant_objects[service_sort[2]].service[0])
print(restaurant_objects[service_sort[2]].name)
#food
print(restaurant_objects[food_sort[0]].food[0])
print(restaurant_objects[food_sort[0]].name)

print(restaurant_objects[food_sort[1]].food[0])
print(restaurant_objects[food_sort[1]].name)

print(restaurant_objects[food_sort[2]].food[0])
print(restaurant_objects[food_sort[2]].name)
# window.mainloop()
